...
class WalletTreeDataProvider {
    ...
    async getChildren(element) {
        if (element) {
            // This example doesn't have child nodes for wallets,
            // but you could add transaction history here.
...
class WalletTreeItem extends vscode.TreeItem {
    constructor(label, address, balance, collapsibleState) {
        ...
        this.contextValue = 'wallet'; // Used for context-menu actions in package.json
